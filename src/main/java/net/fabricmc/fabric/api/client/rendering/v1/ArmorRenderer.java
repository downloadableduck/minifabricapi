 ...
 *
 * <p>The renderers are registered with {@link ArmorRenderer#register(Factory, ItemLike...)}
 * or {@link ArmorRenderer#register(ArmorRenderer, ItemLike...)}.
 */
@FunctionalInterface
public interface ArmorRenderer {
	 ...
	 */
	static void register(Factory factory, ItemLike... items) {
