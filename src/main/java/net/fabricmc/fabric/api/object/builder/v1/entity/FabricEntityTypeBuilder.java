...
public class FabricEntityTypeBuilder<T extends Entity> {
	 ...
	 * @deprecated use {@link EntityType.Builder#build(ResourceKey)}
	 */
	@Deprecated
	public EntityType<T> build(ResourceKey<EntityType<?>> key) {
		...
		if (this.forceTrackedVelocityUpdates != null) {
			builder = builder.setShouldReceiveVelocityUpdates(this.forceTrackedVelocityUpdates);
		}
	...
	public static class Living<T extends LivingEntity> extends FabricEntityTypeBuilder<T> {
		...
		/**
		 * @deprecated use {@link Living#trackRangeBlocks(int)}, {@link Living#trackedUpdateRate(int)} and {@link Living#forceTrackedVelocityUpdates(boolean)}
		 */
		@Override
		@Deprecated
	...
	public static class Mob<T extends net.minecraft.world.entity.Mob> extends Living<T> {
		...
		/**
		 * @deprecated use {@link Mob#trackRangeBlocks(int)}, {@link Mob#trackedUpdateRate(int)} and {@link Mob#forceTrackedVelocityUpdates(boolean)}
		 */
		@Override
		@Deprecated
